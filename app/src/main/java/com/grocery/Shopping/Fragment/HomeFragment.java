...
import com.grocery.Shopping.Activity.City_Select;
import com.grocery.Shopping.Activity.Vender_Category;
import com.grocery.Shopping.Adapter.CatergoryAdapter;
import com.grocery.Shopping.Adapter.FreshStoreAdapter;
import com.grocery.Shopping.Adapter.OurTipsAdapter;
import com.grocery.Shopping.Adapter.PopularListAdapter;
import com.grocery.Shopping.Adapter.SliderAdapterExample;
import com.grocery.Shopping.Adapter.WeddingPlanAdapter;
import com.grocery.Shopping.Interface.Last_cate_Interface;
import com.grocery.Shopping.Pojo.ServiceListPojo;
import com.grocery.Shopping.Pojo.SliderItem;
import com.grocery.Shopping.R;
import com.grocery.Shopping.ViewModel.ServiceViewModel;
...
public class HomeFragment extends Fragment implements Last_cate_Interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // navigationView.setNavigationItemSelectedListener(this);
        ...
        FreshStoreAdapter freshStoreAdapter = new FreshStoreAdapter(getActivity());
        recycleView_vender_bride.setHasFixedSize(true);
        recycleView_vender_bride.setLayoutManager(new GridLayoutManager(getActivity(),3));
        recycleView_vender_bride.setAdapter(freshStoreAdapter);

        recycleView_vender_groom.setHasFixedSize(true);
        recycleView_vender_groom.setLayoutManager(new GridLayoutManager(getActivity(),3));
        recycleView_vender_groom.setAdapter(freshStoreAdapter);
